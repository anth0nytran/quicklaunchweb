        ...
        <header className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          ...
          {featuredGuide ? (
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-7">
              ...
              <p className="mt-3 text-sm !text-white/80">{featuredGuide.description}</p>
                ...
                {pillarGuides.map((guide, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm !text-white/80 max-w-2xl">{guide.description}</p>
                    </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm !text-white/80">{guide.description}</p>
                    </div>
                  </div>
