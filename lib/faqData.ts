...
export const faqs: FAQItem[] = [
  ...
  { q: "What comes with each plan?", a: "Starter ($99/mo): a simple 1-page site, basic SEO, and 1 content update each month.\nGrowth Engine ($199/mo): a 5-page site, SEO + AI search setup, Google Business Profile setup, review follow-up, 1 AI search-ready blog post each month, a monthly ranking snapshot, and 2 content updates.\nCity Dominator ($399/mo): everything in Growth Engine plus service pages, 2 city pages each month, 2 AI search-ready blog posts, every page set up so AI tools can find you, priority edits, and 4 content updates.", category: "plans" },
  ...
  { q: "Can you help me show up on Google and AI search?", a: "Yes. Every site includes basic SEO. Growth Engine adds SEO plus AI search setup, Google Business Profile help, review follow-up, and content written so AI tools can find you. City Dominator takes it further with city pages, AI search-ready blog posts, and every page set up so you show up when people ask AI for help near them.", category: "results" },
